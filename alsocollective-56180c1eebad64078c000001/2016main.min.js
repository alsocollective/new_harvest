...
app.nav = {
	init: function() {
		...
		$("#main_nav_button").click(app.nav.toggle_nav)
	},
	toggle_nav: function(a) {
		console.log("app.nav.toggle_nav");
		var b = $("#main_nav");
		if (b.hasClass("open")) {
			...
			$("#wrapper").click(app.nav.click_off)
		}
	},
	click_off: function(a) {
		console.log("close");
		$("#main_nav").removeClass("open");
		$("#wrapper").off()
	}
...
app.slider = {
	init: function() {
		...
		$(".fundraiser_slider_container").slick({
			arrows: true,
			autoplay: false
		});
		$(".go_to_slide").click(app.slider.go_to_slide)
	},
	go_to_slide: function(a) {
		a.preventDefault();
		$(".fundraiser_slider_container").slick("slickGoTo", $(this).data("slide"));
		return false
	}
};